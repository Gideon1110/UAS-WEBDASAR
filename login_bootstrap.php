...
// Pastikan file user.json ada dulu
if (!file_exists('user.json')) {
  ...
  file_put_contents('user.json', json_encode($default_user));
}
...
<body class="d-flex align-items-center py-4 bg-body-tertiary"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <div class="text-center">
        <img class="mb-4" src="https://i1.wp.com/ikj.ac.id/wp-content/uploads/2019/12/kemendikbud-logo-png-7.png" alt="" width="100">
    </div>

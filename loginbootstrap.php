...
<body class="d-flex align-items-center py-4 bg-body-tertiary"> <svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <main class="form-signin w-100 m-auto border border-3 border-warning rounded-5 bg-white">
        <form>
            <div class="text-center"><img class="mb-4" src="https://i1.wp.com/ikj.ac.id/wp-content/uploads/2019/12/kemendikbud-logo-png-7.png" alt="" width="100"></div>
            <h1 class="h3 mb-3 fw-normal text-center">Please sign in</h1>
            <div class="form-floating"> <input type="email" class="form-control" id="floatingInput" placeholder="name@example.com"> <label for="floatingInput">Email</label> </div>
            ...
            <p class="mt-5 mb-3 text-body-secondary text-center">&copy; 2025–2035</p>
        </form>
    </main>
